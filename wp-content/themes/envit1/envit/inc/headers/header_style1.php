<?php 	global $envit_option; 
		...
		if (! is_front_page())
			...
			$bannerpos = 'relative';
?>
<header id="header" class="<?php echo esc_attr($bannerpos); ?>">
	<?php 
		 ...
		 <div class="thm-container clearfix">
			<div class="logo pull-left main-logo">
				<?php	
					...
					if (isset($envit_option['logo_header_one']['url'] )):
				?>
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
					<img src="<?php echo esc_url( $envit_option['logo_header_one']['url'] ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="img-responsive">
				</a>
				<?php elseif($logo ) : ?>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
			  ...
			  <ul>
				<li>
				  <div class="single-header-right-info">
					<?php if(isset($envit_option['header_one_line_one']) && $envit_option['header_one_line_one'] != '' || isset($envit_option['header_one_line_two']) && $envit_option['header_one_line_two'] != '' ):?>
					<div class="icon-box"><i class="<?php echo esc_attr($envit_option['header_one_line_one_icon']); ?>"></i></div>
					<div class="text-box">
					<h5><?php echo esc_attr($envit_option['header_one_line_one']); ?></h5>
					  <p><?php echo esc_attr($envit_option['header_one_line_two']); ?></p>
					</div>
					<?php endif; ?>
				  </div>
				</li>
				<li>
				  <div class="single-header-right-info">
					<?php if(isset($envit_option['header_one_phone_line_one']) && $envit_option['header_one_phone_line_one'] != '' || isset($envit_option['header_one_phone_line_two']) && $envit_option['header_one_phone_line_two'] != '' ):?>
						<div class="icon-box"><i class="<?php echo esc_attr($envit_option['header_one_phone_line_one_icon']); ?>"></i></div>
						<div class="text-box">
						<h5><?php echo esc_attr($envit_option['header_one_phone_line_one']); ?></h5>
						  <p><?php echo esc_attr($envit_option['header_one_phone_line_two']); ?></p>
              ...
              <div class="navi">
                <div class="nav-menu pull-left text-left">
					<div class="logo pull-left responsive-logo">
						<?php	
							$logo = get_template_directory_uri() .'/assets/images/tmp/logo.png';
							if (isset($envit_option['mobile_logo']['url'] )):
						?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
							<img src="<?php echo esc_url( $envit_option['mobile_logo']['url'] ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="img-responsive">
						</a>
						<?php elseif($logo ) : ?>
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
								<img src="<?php echo esc_url( $logo ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="img-responsive">
